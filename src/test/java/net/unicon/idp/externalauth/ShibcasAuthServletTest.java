...
public class ShibcasAuthServletTest {
    ...
    public void testStartLoginRequestEmbeddedEntityId() throws Exception {
        ...
        shibcasAuthServlet.startLoginRequest(request, response, false, false, "");
        verify(response).sendRedirect("https://cassserver.example.edu/cas/login?service=https%3A%2F%2Fshibserver.example.edu%2Fidp%2FAuthn%2FExternal%3Fconversation%3De1s1%26entityId%3Dhttp%253A%252F%252Ftest.edu%252Fsp");
    }
