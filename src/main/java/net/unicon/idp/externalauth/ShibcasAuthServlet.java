...
public class ShibcasAuthServlet extends HttpServlet {
    ...
    private void parseProperties(final Environment environment, String properties_prefix) {
        ...
        casServerValidatorPrefix = StringUtils.defaultIfBlank(environment.getProperty(properties_prefix + ".casServerValidatorPrefix"), casServerPrefix);
        logger.debug(properties_prefix + ".casServerValidatorPrefix: {}", casServerValidatorPrefix);
